...
export const TRANSLATIONS = {
  uz: {
    welcome: "Televizion texnologiyalari",
    ...
    submit: "Yuborish",
    footerAbout:
      "Televizion texnologiyalari fakulteti - bu innovatsiyalar, media va muhandislik uyg'unligi.",
    ...
    whatIsDesc:
      "Zamonaviy media, televideniye va raqamli axborot texnologiyalari sohasida yuqori malakali mutaxassislar tayyorlovchi ta’lim yo‘nalishidir. Fakultetda talabalar video ishlab chiqarish, signal uzatish, multimedia tizimlari va raqamli kontent yaratish bo‘yicha chuqur bilim va amaliy ko‘nikmalarga ega bo‘ladilar.",
    vrarTitle: "VR / AR Imkoniyatlari",
    vrarDesc:
      "Virtual va kengaytirilgan voqelik - bu bizning o'quv jarayonimizning ajralmas qismi. Talabalarimiz murakkab muhandislik tizimlarini virtual muhitda simulyatsiya qilish imkoniyatiga ega.",
    ...
    programsSubtitle:
      "Kreativ va texnologik sohalarning eng yaxshi o'quv dasturlari.",
  ...
  ru: {
    welcome: "Телевизионные технологии",
    ...
    whatIsDesc:
      "Hаправление образования, готовящее высококвалифицированных специалистов в области современных медиа, телевидения и цифровых информационных технологий. На факультете студенты получат глубокие знания и практические навыки в области видеопроизводства, передачи сигналов, мультимедийных систем и создания цифрового контента.",
    ...
    programsSubtitle:
      "Лучшие учебные программы в креативных и технологических сферах.",
  ...
  en: {
    welcome: "Television technologies",
    ...
    programsSubtitle:
      "Best training programs in creative and technological fields.",
