            ...
            >
              ...
              <div className="mt-10 grid grid-cols-2 gap-8">
                <div className="glass p-6 rounded-2xl">
                  <i className="fas fa-paint-brush text-cyan-500 text-3xl mb-4"></i>
                  <h4 className="font-bold mb-2">
                    Kompyuter grafikasi va dizayn
                  </h4>
                  <p className="text-xs text-gray-500">
                    Grafika, animatsiya va vizual dizayn yaratish
                    texnologiyalari
                  </p>
                </div>

                <div className="glass p-6 rounded-2xl">
                  <i className="fas fa-photo-video text-cyan-500 text-3xl mb-4"></i>
                  <h4 className="font-bold mb-2">
                    Televizion va media texnologiyalar
                  </h4>
                  <p className="text-xs text-gray-500">
                    Video suratga olish, montaj va media ishlab chiqarish
                    jarayonlari
                  </p>
                </div>
              </div>
            ...
            {[
              {
                ...
                title: "Immersiv ta’lim",
                desc: "Virtual sinfxonalar va masofadan turib amaliy mashg‘ulotlarni bajarish imkoniyati.",
              },
              {
                icon: "fas fa-cube",
                title: "3D modellashtirish",
                desc: "Murakkab obyektlarni real vaqt rejimida yaratish va simulyatsiya qilish.",
              },
              {
                icon: "fas fa-hand-pointer",
                title: "Interaktiv media",
                desc: "Foydalanuvchi bilan o‘zaro ishlovchi zamonaviy vizual va media tajribalar.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
              ...
              >
                <div className="w-16 h-16 bg-cyan-500/10 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-cyan-500 transition-all">
                  <i
                    className={`${item.icon} text-2xl text-cyan-500 group-hover:text-white`}
                  ></i>
                </div>
        ...
        <section className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
            {[
              ...
              >
                <h3 className="text-5xl md:text-7xl font-black text-gradient mb-2">
                  {stat.val}
                </h3>
        ...
        <section className="container mx-auto px-6">
          <div className="glass rounded-[4rem] p-10 md:p-20 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-5xl font-black mb-8 leading-tight flex gap-4">
                  AI
                  <span className="text-gradient">Yordamchi</span>
                </h2>
                <p className="text-gray-400 text-lg mb-12 font-light">
                  Fakultetimiz, o‘quv dasturlarimiz yoki media texnologiyalari
                  sohasidagi karyera imkoniyatlari haqida istalgan savolingizni
                  bering.
                </p>
                <form onSubmit={handleAiAsk} className="relative">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="absolute right-4 top-4 bottom-4 bg-cyan-600 px-8 py-2 rounded-xl hover:bg-cyan-500 transition-all"
                  >
                    {loading ? (
